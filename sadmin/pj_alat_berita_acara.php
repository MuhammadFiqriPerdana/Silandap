...
if(isset($_GET['kode'])){
    $sql_cek = "SELECT * FROM tb_berita_acara_peminjaman ba
    INNER JOIN tbl_peminjaman pj on ba.id_peminjaman = pj.id_peminjaman
    INNER JOIN tbl_user u on u.id_user = pj.id_user";
