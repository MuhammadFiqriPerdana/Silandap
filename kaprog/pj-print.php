...
$sql_cek = "SELECT * FROM tbl_peminjaman pj INNER JOIN tbl_user u ON u.id_user = pj.id_user INNER JOIN tbl_barang b ON pj.id_barang = b.id_barang LEFT JOIN tbl_pengembalian k on pj.id_peminjaman = k.id_pin WHERE k.id_pin IS NULL AND b.kategori = 'Alat'";
