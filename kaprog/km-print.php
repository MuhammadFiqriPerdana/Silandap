...
$sql_cek = "SELECT * FROM tbl_peminjaman pj INNER JOIN tbl_user u ON pj.id_user = u.id_user INNER JOIN tbl_barang b ON pj.id_barang = b.id_barang LEFT JOIN tbl_pengembalian km on pj.id_peminjaman = km.id_pin WHERE km.id_pengembalian IS NOT NULL AND b.kategori = 'Alat'";
...
<table style="border: 1px solid #fff; width: 100%;">
    ...
    <h3 align="center">LAPORAN DATA PENGEMBALIAN ALAT PRAKTEK</h3>
    ...
    foreach( $query_cek as $row) {
        ...
        <td align="center">'. $row["waktu_kembali"].'</td>
        </tr>';
    }
