...
$sql_cek = "SELECT * FROM tb_berita_acara_pengembalian b
INNER JOIN tbl_pengembalian k ON b.id_pengembalian = k.id_pengembalian
...
<table style="border: 1px solid #fff; width: 100%;">
    ...
    <h3 align="center">Rekapitulasi Berita Acara Pengembalian Alat Praktek</h3>
    ...
    foreach( $query_cek as $row) {
        ...
        <td align="center">'. $row["id_berita_acara_pengembalian"].'</td>
