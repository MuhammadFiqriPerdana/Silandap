...
$sql_cek = "SELECT * FROM tbl_peminjaman pj INNER JOIN tbl_user u ON u.id_user = pj.id_user INNER JOIN tbl_barang b ON pj.id_barang = b.id_barang LEFT JOIN tbl_pengembalian k on pj.id_peminjaman = k.id_pin WHERE k.id_pin IS NULL";
...
<table style="border: 1px solid #fff; width: 100%;">
    ...
    <h3 align="center">LAPORAN DATA PEMINJAMAN ALAT DAN PEMAKAIAN BAHAN PRAKTEK</h3>
