...
if(isset($_GET['id'])){
     $sql_cek = "SELECT * FROM tbl_pengembalian K
     LEFT JOIN tb_berita_acara_pengembalian BK ON K.id_pengembalian = BK.id_pengembalian
     LEFT JOIN tbl_peminjaman P ON K.id_pin = P.id_peminjaman
     LEFT JOIN tbl_barang B ON P.id_barang = B.id_barang
     LEFT JOIN tbl_user U ON P.id_user = U.id_user
     WHERE BK.id_pengembalian = '".$_GET['id']."'";
...
<table style="border: 1px solid #fff; width: 100%;">
    ...
    <h3 align="center">Berita Acara Pengembalian Alat Pratek</h3>
    <table style="border: 1px solid #fff;">
    <tr>
    <td>Id Berita Acara : '.$hasil['id_berita_acara_pengembalian'].'</td>
    </tr>
    <tr>
    ...
    <table style="border: 1px solid #fff;">
        ...
        <tr>
            ...
            <br>
            <br>Banjarbaru, '.tanggal_indo(date('Y-m-d')).'
            </td>
        </tr>
